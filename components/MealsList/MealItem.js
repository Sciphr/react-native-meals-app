...
import { useNavigation } from '@react-navigation/native'; //Using this hook instead of props.navigation because MealItem is not a screen setup in App.js
...
const styles = StyleSheet.create({
  mealItem: {
    ...
    shadowOpacity: 0.35, // only for iOS
    shadowOffset: { width: 0, height: 2 }, // only for iOS
    shadowRadius: 16, // only for iOS
